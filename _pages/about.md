...
- [J4] He, K. , **Tao, S.** et al. A Novel Quick Screening Method for the Second Usage of Parallel-connected Lithium-ion Cells Based on the Current Distribution. _Journal of The Electrochemical Society_ **170**, 030514 (2023). Click to [view](https://doi.org:10.1149/1945-7111/acbf7e).
- [J3] Li, T. , **Tao, S.** et al. V2G Multi-Objective Dispatching Optimization Strategy Based on User Behavior Model. _Frontiers in Energy Research_ **9** (2021). Click to [view](https://doi.org:10.3389/fenrg.2021.739527)
